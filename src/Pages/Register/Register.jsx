        ...
        createUser(data.email, data.password)
            .then(result => {
                ...
                profileUpdate(data.name, data.photo)
                    .then(() => {
                        axios.post('https://summer-server-theta.vercel.app/users', { name: data.name, email: data.email, photo: data.photo })
                            .then(res => {
    ...
    const handleSocialLogin = () => {
        loginByGoogle()
            .then((result) => {
                ...
                axios.post('https://summer-server-theta.vercel.app/users', { name: loggedUser.displayName, email: loggedUser.email, photo: loggedUser.photoURL })
                    .then(res => {
                        console.log(res.data);
                        Swal.fire({
                            position: 'center',
